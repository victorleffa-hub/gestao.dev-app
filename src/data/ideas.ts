...
export const IDEAS: Idea[] = [
  { id: '1', title: 'IA para sugestao de sprints', description: 'Usar historico de tarefas para sugerir duracao e scope de sprints automaticamente', status: 'approved', category: 'ai', votes: 21, author: 'Victor Leffa' },
  ...
  { id: '8', title: 'App mobile nativo', description: 'Versao iOS/Android do gestao.dev para acompanhamento em campo', status: 'converted', category: 'mobile', votes: 0, author: 'Victor Leffa' },
];
